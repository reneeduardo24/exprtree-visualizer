...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">exprtree-visualizer documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/RecursiveParserPanelComponent.html" data-type="entity-link" >RecursiveParserPanelComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/TreeVisualizerComponent.html" data-type="entity-link" >TreeVisualizerComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/ExpressionStateService.html" data-type="entity-link" >ExpressionStateService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/BuildStep.html" data-type="entity-link" >BuildStep</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ExpressionInputModel.html" data-type="entity-link" >ExpressionInputModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ExpressionNode.html" data-type="entity-link" >ExpressionNode</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ExpressionNode-1.html" data-type="entity-link" >ExpressionNode</a>
                            </li>
                            <li class="link">
